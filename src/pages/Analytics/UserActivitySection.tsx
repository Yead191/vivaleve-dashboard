...
import { analyticsDau, wauMau, newSignupsBars, churnRate } from '../../data/mockData';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          <StatCard label="Churn rate (30d)" value={churnRate.value} delta={churnRate.delta} deltaDir={churnRate.dir as any} icon={TrendingDown} tone="rose" sub="vs prior period" />
