...
import { revenueStats, revenueByPlan, monthlyRevenue } from '../../data/mockData';

export default function RevenueTab() {
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="MRR"     value={revenueStats.mrr.value} delta={revenueStats.mrr.delta} deltaDir={revenueStats.mrr.dir as any} icon={TrendingUp}  tone="green" sub="vs last month" />
        <StatCard label="ARR"     value={revenueStats.arr.value} delta={revenueStats.arr.delta} deltaDir={revenueStats.arr.dir as any} icon={TrendingUp}  tone="brand" sub="annualized" />
