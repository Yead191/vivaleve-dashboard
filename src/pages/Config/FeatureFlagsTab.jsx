...
import { featureFlags } from '../../data/mockData.js';

const envColors = { dev: 'cyan', staging: 'gold', prod: 'red' };
...
export default function FeatureFlagsTab() {
  ...
  const openEdit = (f) => { setEditing(f); form.setFieldsValue(f); setOpen(true); };
